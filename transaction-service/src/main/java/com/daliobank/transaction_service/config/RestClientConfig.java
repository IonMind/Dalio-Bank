                ...
                return RestClient.builder()
                                ...
                                .defaultStatusHandler(
                                                ...
                                                (request, response) -> {
                                                        ...
                                                        log.error("REQUEST-> " + request.getURI().toString()
                                                                        + " Response-> "
                                ...
                                .defaultStatusHandler(
                                                ...
                                                (request, response) -> {
                                                        ...
                                                        log.error("REQUEST-> " + request.getURI().toString()
                                                                        ...
                                                                        + response.getStatusCode().value()
                                                                        + errorResponse);
                                                        throw new InvalidTransactionType(errorResponse); // errors like
                                                                                                         // inscufficient
                                                                                                         // balance
                                                })
                                .defaultStatusHandler(
                                                statusCode -> statusCode.isSameCodeAs(HttpStatusCode.valueOf(500)),
                                                (request, response) -> {
                                                        String errorResponse = new String(
                                                                        response.getBody().readAllBytes());
                                                        log.error("REQUEST-> " + request.getURI().toString()
